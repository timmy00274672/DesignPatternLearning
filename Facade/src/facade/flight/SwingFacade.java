...
public class SwingFacade {
	...
	fPanel.setPreferredSize(new Dimension(200,100));
	JPanel panel = SwingFacade.createTitledPanel("Flight Path", fPanel);
	SwingFacade.launch(panel, "Flight Path for Shell Duds");
    }
}